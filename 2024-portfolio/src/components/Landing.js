...
export const Landing = () => {
    ...
    const cardData = [
        ...
        <CustomCard tag="Other"  iconSrc={godot} bodyText='Godot is a cross-platform, free and open-source game engine released under the permissive MIT license. ' link='https://godotengine.org/' headerText='Godot' headerUrl='godotengine.org' linkText='View Documentation'/>,
